    ...
    <>
      <nav>
        <ul>
          ...
          <li>
            <Link to="/notificationDetails">NotificationDetails</Link>
          </li>
          ...
          <li>
            <Link to="/sellerApplication">SellerApplication</Link>
          </li>
          <li>
            <Link to="/sellerManagement">SellerManagement</Link>
          </li>

          <li>
            <Link to="/fundingMain">FundingMain</Link>
          </li>
          <li>
            <Link to="/fundingView">FundingView</Link>
          </li>
          <li>
            <Link to="/fundingDetails">FundingDetails</Link>
          </li>
